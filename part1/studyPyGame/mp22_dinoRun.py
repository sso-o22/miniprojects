...
def menu(death_count):  # 메뉴 함수
    ...
    while run:
        ...
        if death_count == 0:  # 최초
            ...
            SCREEN.blit(START, (SCREEN_WIDTH // 2 - 20, SCREEN_HEIGHT // 2 - 140))  # 시작화면에 공룡 이미지
            ...
            SCREEN.blit(score, scoreRect)  # 화면에 점수 넣어줌
            SCREEN.blit(DEAD, (SCREEN_WIDTH // 2 - 20, SCREEN_HEIGHT // 2 - 140))  # 죽은 공룡 이미지
